...
class ExtendedLoggerTest extends UnitTestCase {
  ...
  public function testLog() {
    ...
    $fields = array_combine(array_keys(ExtendedLogger::LOGGER_FIELDS), array_keys(ExtendedLogger::LOGGER_FIELDS));
    $fieldsCustom = ['customField2', 'custom_field_5', 'custom_field_6'];

    TestHelpers::service('config.factory')->stubSetConfig(ExtendedLogger::CONFIG_KEY, [
      'fields' => $fields,
